# 模块：sem_automation/materials/keywords/wordstat.py；内部模块由统一入口调用。
...
#直接终端运行 .\.venv\Scripts\python.exe -m sem_automation.materials.keywords.wordstat
...
def main():
    ...
    base = material_dir("outputs", project_name, root)
