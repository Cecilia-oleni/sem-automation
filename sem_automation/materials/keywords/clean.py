# 模块：sem_automation/materials/keywords/clean.py；内部模块由统一入口调用。
...
# 默认运行： .\.venv\Scripts\python.exe -m sem_automation.materials.keywords.clean
# 指定项目：.\.venv\Scripts\python.exe -m sem_automation.materials.keywords.clean --project 星纵物联
# 按搜索量降序排列： .\.venv\Scripts\python.exe -m sem_automation.materials.keywords.clean --project 星纵物联 --sort-volume
